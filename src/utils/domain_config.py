...
DOMAIN_TABLE: Dict[str, Dict[str, object]] = {
    ...
    "1":  {"name": "计算机科学", "decay_rate": 4},   # CS / AI：更新快，6 年半衰期
    "2":  {"name": "医学",       "decay_rate": 5},   # 医学：7 年
    "3":  {"name": "政治学",     "decay_rate": 8},  # 政治/政策：10 年
    "4":  {"name": "工程学",     "decay_rate": 6},   # 工程/控制/机器人：8 年
    "5":  {"name": "物理学",     "decay_rate": 10},  # 物理：12 年
    "6":  {"name": "材料科学",   "decay_rate": 8},  # 材料：10 年
    "7":  {"name": "生物学",     "decay_rate": 6},   # 生物：8 年
    "8":  {"name": "地理学",     "decay_rate": 10},  # 地理：12 年
    "9":  {"name": "化学",       "decay_rate": 8},  # 化学：10 年
    "10": {"name": "商学",       "decay_rate": 6},   # 商学/管理：8 年
    "11": {"name": "社会学",     "decay_rate": 8},  # 社会学：10 年
    "12": {"name": "哲学",       "decay_rate": 18},  # 哲学/人文：20 年
    "13": {"name": "环境科学",   "decay_rate": 8},  # 环境科学：10 年
    "14": {"name": "数学",       "decay_rate": 16},  # 数学：18 年
    "15": {"name": "心理学",     "decay_rate": 8},  # 心理学：10 年
    "16": {"name": "地质学",     "decay_rate": 13},  # 地质：15 年
    "17": {"name": "经济学",     "decay_rate": 8},  # 经济学：10 年
}
