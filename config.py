...
CYPHER_TEMPLATES = {
    "INIT_SCHEMA": [
        ...
        "CREATE INDEX IF NOT EXISTS FOR (a:Author) ON (a.last_updated)",
        ...
        "CREATE INDEX IF NOT EXISTS FOR ()-[r:AUTHORED]-() ON (r.pos_weight)"
    ],
...
SQL_INIT_SCRIPTS = [
    ...
    "CREATE INDEX IF NOT EXISTS idx_aship_work_author ON authorships(work_id, author_id, inst_id)",
